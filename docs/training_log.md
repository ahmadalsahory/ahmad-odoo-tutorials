...
- **Commits**:
  - `2d601b6` - feat(sales_commission): handle range gaps by returning preceding lower tier rate
  - `b00831a` - feat(sales_commission): add range overlap validation and highest tier fallback rate
